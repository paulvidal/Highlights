...
GET_STARTED_MESSAGE = "Hey {}, " + EMOJI_WAVE + "\n\nI am the smart bot that fetches the latest football highlights for you. I will guide you throughout this tutorial."

GET_STARTED_MESSAGE_2 = "To get started, enter the name of a " + EMOJI_FOOTBALL + " team you would love to subscribe to."

SUBSCRIPTION_MESSAGE = "I am currently sending you the highlights for the following " + EMOJI_FOOTBALL + " teams: \n\n{}\n\nDo you want to ADD or REMOVE a team?"
