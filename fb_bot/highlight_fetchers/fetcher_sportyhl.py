...
from fb_bot.highlight_fetchers.utils.link_formatter import format_streamable_link, _format_link, format_dailymotion_link, \
            ...
            if nltk.edit_distance(type.lower(), accepted) <= 2 or accepted in type.lower():
                ...
                if src:
                    ...
                    if providers.DAILYMOTION in src:
                        ...
                        video_link = format_ok_ru_link(src)

                    elif providers.MATCHAT_ONLINE in src:
                        video_link = format_matchat_link(src)
