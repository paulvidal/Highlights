...
from fb_bot.model_managers import football_team_manager, football_competition_manager, latest_highlight_manager, \
    context_manager, registration_competition_manager, registration_team_manager
from fb_highlights.models import User, BlockedNotification
from fb_highlights.tests.utils.test_highlights import TEST_HIGHLIGHTS, TIME_NOW, TIME_40_MINUTES_EARLIER, \
    TIME_1_DAY_EARLIER, TIME_3_DAYS_EARLIER, SENT_HIGHLIGHTS, INCREMENT_CLICK_COUNT, TEST_HIGHLIGHTS_2
